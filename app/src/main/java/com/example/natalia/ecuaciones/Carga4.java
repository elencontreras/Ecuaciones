...
public class Carga4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carga4);
        res= this.getResources();
        txtBase=(EditText) findViewById(R.id.txtBase4);
        txtAltura=(EditText) findViewById(R.id.txtAltura4);
        txtLongitud=(EditText) findViewById(R.id.txtLongitud4);
        txtCarga=(EditText) findViewById(R.id.txtCarga4);
        cmbMaterial=(Spinner)findViewById(R.id.cmbMaterial4);
    ...
    public void calcularCarga4(View v) {
