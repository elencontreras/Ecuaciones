...
public class Carga2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtBase=(EditText) findViewById(R.id.txtBase2);
        txtAltura=(EditText) findViewById(R.id.txtAltura2);
        txtLongitud=(EditText) findViewById(R.id.txtLongitud2);
        txtCarga=(EditText) findViewById(R.id.txtCarga2);
        cmbMaterial=(Spinner)findViewById(R.id.cmbMaterial2);
    ...
    public void calcularCarga2(View v) {
        ...
        if (validar()) {
            ...
            double num = carga * Math.pow(longitud, 4);
            double den = 8 * young * inercia;
